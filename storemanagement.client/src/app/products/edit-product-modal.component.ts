...
export class EditProductModalComponent implements OnInit {
  ...
  private populateForm(): void {
    const tagsInput = this.product.tags ? this.product.tags.join(', ') : '';
    
    this.productForm.patchValue({
      ...this.product,
      tagsInput,
      manufacturedDate: this.product.manufacturedDate ? new Date(this.product.manufacturedDate) : '',
      expiryDate: this.product.expiryDate ? new Date(this.product.expiryDate) : ''
    });
  }
